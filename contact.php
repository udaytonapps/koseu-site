...
$OUTPUT->pageTitle('Center for Online Learning');
?>
    <div class="row">
        <div class="col-sm-8">
            <p>Welcome to the Center for Online Learning at the University of Dayton. Our goal is to support innovative teaching and learning initiatives for on-campus and online programs while maintaining high quality support of our existing solutions.</p>
            ...
            <h3>Mission</h3>
            <p>The Center for Online Learning is committed to:</p>
            <ul>
        ...
        <div class="col-sm-4">
            <div style="padding-left:2rem;padding-bottom:0.5rem;border-left:1px solid var(--text);">
                ...
                <p><span class="fa fa-envelope" aria-hidden="true"></span><span class="sr-only">Email:</span> <strong>onlinelearning@udayton.edu</strong></p>
                <h3>Hours</h3>
                <dl>
                    <dt>Monday - Friday</dt>
